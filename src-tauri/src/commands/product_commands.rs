...
#[tauri::command]
pub async fn edit_item(id: i32, name: String, price: f64, barcode: Option<String>, category: String, sellformat: String, min_stock: Option<f64>, max_stock: Option<f64>, state: tauri::State<'_, crate::DbState>) -> Result<(), String> {
...
#[tauri::command]
pub async fn create_item(name: String, price: f64, category: String, barcode: Option<String>, sellformat: String, quantity: f64, min_stock: Option<f64>, max_stock: Option<f64>, state: tauri::State<'_, crate::DbState>) -> Result<i32, String> {
